...
public class Settings 
{
	...
	//Crop Settings
	public static boolean disablePumpkins = false;
	public static boolean disableMelons = false;
	...
	public static boolean vanillaMelons = false;
	public static boolean vanillaMushrooms = false;
	public static boolean vanillaMelonRecipe = false;
	public static boolean tfcPumpkinRecipe = false;
}
