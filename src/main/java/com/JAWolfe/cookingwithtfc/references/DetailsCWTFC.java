...
public class DetailsCWTFC 
{
	...
	public static final String SERVER_PROXY_CLASS = "com.JAWolfe.cookingwithtfc.proxy.ServerProxyCWTFC";
	public static final String CLIENT_PROXY_CLASS = "com.JAWolfe.cookingwithtfc.proxy.ClientProxyCWTFC";
